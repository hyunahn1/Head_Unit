...
static const char *kScreenStyle = R"(
    ...
    QListView::item {
        color: #B3B3B7; padding: 10px 16px; border-radius: 8px; border: none;
    }
...
static const char *kCtrlBtnStyle = R"(
    QPushButton {
        ...
        border: none; border-radius: 8px; font-size: 16pt;
    }
...
static const char *kPlayBtnStyle = R"(
    QPushButton {
        ...
        border: none; border-radius: 28px; font-size: 18pt;
    }
...
static const char *kAddBtnStyle  = R"(
    QPushButton {
        ...
        font-size: 12pt; padding: 4px 14px;
    }
    ...
    , m_gearPanel(nullptr)
{
    ...
    m_albumArt->setFixedSize(160, 160);
    ...
    m_trackTitle->setStyleSheet("font-size: 17pt; font-weight: bold; color: #FFFFFF;");
    ...
    m_artistName->setStyleSheet("font-size: 13pt; color: #B3B3B7;");
    ...
    m_posLabel->setStyleSheet("font-size: 11pt; color: #6E6E73; min-width: 36px;");
    ...
    m_durLabel->setStyleSheet("font-size: 11pt; color: #6E6E73; min-width: 36px;");
    ...
    volIcon->setStyleSheet("font-size: 13pt;");
    ...
    listTitle->setStyleSheet("font-size: 15pt; font-weight: bold; color: #FFFFFF;");
...
void MediaScreen::showPlaceholderArt()
{
    ...
    m_albumArt->setStyleSheet(
        "background-color: #252529; border-radius: 12px;"
        "color: #6E6E73; font-size: 48pt;");
...
void MediaScreen::onCoverArtChanged(const QPixmap &art)
{
    if (art.isNull()) {
        if (m_currentTrack >= 0) {
            ...
            QLinearGradient grad(0, 0, 160, 160);
...
void MediaScreen::onError(const QString &msg)
{
    ...
    m_trackTitle->setStyleSheet(
        "font-size: 17pt; font-weight: bold; color: #FF4757;");
    m_artistName->setText("Cannot play this file — skipping...");
    m_artistName->setStyleSheet("font-size: 12pt; color: #FF475770;");
    showPlaceholderArt();
    ...
    QTimer::singleShot(1500, this, [this] {
        ...
        m_trackTitle->setStyleSheet(
            "font-size: 17pt; font-weight: bold; color: #FFFFFF;");
        m_artistName->setStyleSheet("font-size: 13pt; color: #B3B3B7;");
        onNext();
    });
}
